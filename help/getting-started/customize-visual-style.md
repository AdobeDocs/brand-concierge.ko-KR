---
title: 컨시어지의 비주얼 스타일 맞춤화 - 비디오
description: 시작 메시지, 스타터 프롬프트 카드 및 카드 색상을 포함하여 Adobe Brand Concierge의 시각적 스타일을 사용자 지정하는 방법을 알아봅니다.
...
* 브랜드 및 마케팅 팀
* 콘텐츠 디자이너 및 카피라이터
* 컨시어지가 어떻게 보이는지 세세하게 조율하는 사람

## 비디오 콘텐츠

* Brand Concierge이 웹 사이트에서 시작 색상, 글꼴 및 카드 이미지를 가져오는 방법
* 기본 데스크탑 및 모바일 모양을 테스트하는 방법
