...
* 웹 사이트에 컨시어지를 배포하는 마케터
* 데이터 스트림 ID를 제공하고 스크립트를 설치하는 IT 또는 웹 개발 팀
* 사이트 전체에서 컨시어지가 표시되는 위치를 제어하는 팀

## 비디오 콘텐츠

* 데이터 수집 > 데이터 스트림 아래의 Adobe Experience Platform에서 데이터 스트림 ID를 찾을 수 있는 위치
* 데이터 스트림 구성을 추가하고 결과 설치 스크립트를 복사하는 방법
